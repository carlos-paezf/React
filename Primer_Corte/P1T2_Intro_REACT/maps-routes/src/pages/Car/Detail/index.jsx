        ...
        <>
            <div className="container py-4">
                <header className="pb-3 mb-4 border-bottom">
                    ...
                    <span className="fs-4">Descripción del Vehiculo { id }</span>
                </header>
            </div>
            ...
            <div className="mx-5">
                <div className="card col-md-12">
                    ...
                    <ul className="list-group list-group-flush">
                        ...
                        <li className="list-group-item">Número de ruedas: 4</li>
                        <li className="list-group-item">Número de Puertas: 5</li>
