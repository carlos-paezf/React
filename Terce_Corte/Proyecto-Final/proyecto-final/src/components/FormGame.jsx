...
const FormGame = ({ data, setData, minimumRequirements, setMinimumRequirements, recommendedRequirements, setRecommendedRequirements }) => {
        ...
        <div className="new-game">
            <form onSubmit={handleNewGame} className='g-form'>
                ...
                <div className={(slide === 6) ? "active-form animate__animated animate__fadeIn" : "disable-form"}>
                    <h4>Screnshots</h4>
                    <div className="form-floating">
                        <textarea type="textarea" className="form-control input my-3 textfield textarea" id="screenshotURLs" name="screenshotURLs" value={screenshotURLs} onChange={handleChangeData} placeholder=" " />
